        ...
        <div className="fade-up">
            ...
            >
                <div style={{ maxWidth: 700, margin: '0 auto' }}>
                    ...
                    >
                        Twój wirtualny <br />{' '}
                        <em style={{ color: 'var(--forest)' }}>zielnik w kieszeni</em>
                    </h1>
                    <p
                        style={{
                            fontSize: 18,
                    ...
                    >
                        Odkrywaj polską florę, identyfikuj rośliny aparatem i twórz niepowtarzalne
                        kolekcje botaniczne.
                    </p>
                    ...
                    {stats.map((s, i) => (
                        <div
                            ...
                            style={{
                                flex: 1,
                                padding: '16px 0',
                                borderLeft: i > 0 ? '1px solid #cde4c7' : 'none',
                            }}
                        >
                            <div
                                style={{
